...
def tests(classes, part_hierarchy, class_hierarchy):
    ...
    coded_expanded_class_hierarchy = km.expand(class_codes,coded_class_hierarchy)
    print('Coded Expanded Class Hierarchy: ', coded_expanded_class_hierarchy)
    closed_refinement = km.reflexive_transitive_closure(coded_expanded_class_hierarchy)
    ...
    coded_expanded_part_hierarchy = km.expand(class_codes,coded_part_hierarchy)
    print('Coded Expanded Part Hierarchy: ', coded_expanded_part_hierarchy)
    closed_composition = km.transitive_closure(coded_expanded_part_hierarchy)
    ...
    for variant in generalized_class_variants:
        ...
        print(line)
    variant_tensor = km.encode_variants(len(class_codes), generalized_class_variants)
