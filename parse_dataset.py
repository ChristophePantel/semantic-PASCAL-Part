...
def tests(classes, part_hierarchy, class_hierarchy):
    ...
    print('Code to Class: ', code_to_class)
    ...
    print('Coded Class Hierarchy: ', coded_class_hierarchy)
    coded_expanded_class_hierarchy = expand(class_codes,coded_class_hierarchy)
    print('Coded Expanded Class Hierarchy: ', coded_expanded_class_hierarchy)
    closed_refinement = reflexive_transitive_closure(coded_expanded_class_hierarchy)
    print('Closed Refinement: ', closed_refinement)
    coded_class_hierarchy_inverted = invert_relation(coded_class_hierarchy)
    print('Coded Class Hierarchy inverted: ', coded_class_hierarchy_inverted)
    print('Composition')
    coded_part_hierarchy = associate_codes_to_hierarchies(class_to_code, part_hierarchy)
    print('Coded Part Hierarachy: ', coded_part_hierarchy)
    coded_expanded_part_hierarchy = expand(class_codes,coded_part_hierarchy)
    print('Coded Expanded Part Hierarchy: ', coded_expanded_part_hierarchy)
    closed_composition = transitive_closure(coded_expanded_part_hierarchy)
    print('Closed Composition: ', closed_composition)
    full_composition = resolve( class_codes, coded_part_hierarchy, coded_class_hierarchy)
    print('Full Composition: ', full_composition)
    inverted_full_composition = invert_relation(full_composition)
    print('Inverted Full Composition: ', inverted_full_composition)
    class_variants, variant_to_class = variants(class_codes,inverted_full_composition)
    print('Class Variants: ', class_variants)
    print('Variant to Class: ', variant_to_class)
    generalized_class_variants = generalize(class_variants,closed_refinement)
    print('Generalized Class Variants: ', generalized_class_variants)
    for variant in generalized_class_variants:
        line = ''
        for element in generalized_class_variants[variant]:
            line += code_to_class[element] + ' '
        line += ': ' + code_to_class[variant_to_class[variant]]
        print(line)
    variant_tensor = encode_variants(len(class_codes), generalized_class_variants)
...
if __name__ == '__main__':
    tests(get_class_names(), get_contained_classes(), get_refined_classes())
